...
def forward_error_network(M_E, modu_tensor_list, awg, op_reader, input_curve, ref_inten_list, v_list_input): 
    ...
    Pke_5 = M_E_out
    M_E_out = torch.mul(M_E_out, modu_tensor_list[4])
    ...
    Pke_4 = M_E_out
    M_E_out = torch.mul(M_E_out, modu_tensor_list[3])
    ...
    Pke_3 = M_E_out
    M_E_out = torch.mul(M_E_out, modu_tensor_list[2])
    ...
    Pke_2 = M_E_out
    M_E_out = torch.mul(M_E_out, modu_tensor_list[1])
